...
STATUTE_ROWS: dict[str, dict[str, Any]] = {
    ...
    "us-al": {"manifest": "manifests/state-income-tax-chapters-2026-09-14.yaml", "source_id": "us-al-code-title-40", "versions": ["2026-09-14-income-tax-chapter-us-al-title-40"], "index_url": "https://alison.legislature.state.al.us/code-of-alabama", "chapter": "Code of Alabama Title 40, Chapter 18 (whole Title 40 taken)", "supersedes": ["us-al/statute/2026-07-13-recovery"]},
