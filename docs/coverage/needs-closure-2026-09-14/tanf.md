# TANF: needs-driven closure check (2026-09-11 schema, re-run 2026-09-14 on the sixth cut)
...
> Re-run 2026-09-14 against `manifests/releases/us-rulespec-2026-09-14-wave4-r2-union.json` with the 2026-09-11 element list unchanged (`build_tanf_ccdf_matrix.py --selector`). The Results table is recomputed from the matrix; the narrative gap tables below still describe the 2026-09-11 selection unless marked otherwise. Full roll-ups: `summary-tanf-ccdf.json`.
...
|---|---:|---:|---:|---:|---:|---:|
| federal (us) | 149 | 147 | 1 | 0 | 0 | 1 |
| state (51 x 32) | 1,632 | 1,318 | 13 | 12 | 0 | 289 |
| all | 1,781 | 1,465 | 14 | 12 | 0 | 290 |
