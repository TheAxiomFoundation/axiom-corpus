# WIC: needs-driven closure check (2026-09-11 schema, re-run 2026-09-14 on the sixth cut)

Corpus as selected on 2026-09-11 (draft union selector plus the twelve SNAP superseding scopes on disk); checked 2026-09-14. Schema: `wic-schema.yaml` (114 elements: 83 federal, 31 state). Matrix: `wic-matrix.csv` (5897 cells = 52 jurisdictions x 114 elements, one row each). Builder: `check_snap_wic.py` (read-only over `data/corpus`; 282.3 s, 222 scopes and 74924 provision rows loaded for both programs); PRESENT evidence: `wic-hits.jsonl`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| cells | 773 | 10 | 488 | 270 | 123 | 4233 | 5897 |

Federal elements are checked once at the `us` row and inherited by the 51 states (`INHERITED`, 4233 cells whose note names the federal status). The federal row alone (83 elements): PRESENT 82, EXTRACTABLE 1, ABSENT 0, OUTREACH 0, REVIEW 0. State-level cells (51 x 31 = 1581): PRESENT 691, EXTRACTABLE 9, ABSENT 488, OUTREACH 270, REVIEW 123.

## Federal roll-up by document family

| federal family | elements | PRESENT | EXTRACTABLE | ABSENT | OUTREACH | REVIEW |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| statute | 19 | 19 | 0 | 0 | 0 | 0 |
| regulation (eCFR) | 56 | 56 | 0 | 0 | 0 | 0 |
| FNS/FNA guidance | 8 | 7 | 1 | 0 | 0 | 0 |

Federal cells not PRESENT:

- `wic_g06` EXTRACTABLE: no selected federal scope carries it (regex 'Federal Register|\\d+ FR \\d+|final rule' over 27 federal scopes); publisher lists it: FNA resource browser, WIC Federal Register Notices family (70; none taken; the two income-guideline notices are wic_g01)
...
| us-ut | 31 | 30 | 0 | 0 | 0 | 1 | 1 open |
| us-vt | 31 | 7 | 0 | 1 | 0 | 23 | 23 open |
| us-va | 31 | 28 | 0 | 1 | 0 | 2 | 2 open |
| us-wa | 31 | 29 | 0 | 0 | 0 | 2 | 2 open |
| us-wv | 31 | 30 | 0 | 0 | 0 | 1 | 1 open |
| us-wi | 31 | 26 | 0 | 1 | 0 | 4 | 4 open |
...
| wic_s30 | WIC State Plan filed with FNS (246.4) | state_plan | 43 | 0 | 0 | 9 | 34 |
| wic_s10 | Presumptive / temporary certification of pregnant women pending income or risk documentation | state_manual_or_regulation | 33 | 4 | 17 | 9 | 3 |
| wic_s27 | Farmers' market nutrition program / farm direct | state_manual_or_regulation | 31 | 0 | 22 | 9 | 0 |
| wic_s12 | Processing standards (10/20 days) and appointment scheduling | state_manual_or_regulation | 30 | 1 | 17 | 9 | 3 |
| wic_s20 | Notice of ineligibility, termination and expiration | state_manual_or_regulation | 30 | 2 | 16 | 9 | 3 |
| wic_s01 | State income eligibility standard (185 percent or lower) and current income guidelines table | state_manual_or_regulation | 28 | 0 | 17 | 9 | 2 |
| wic_s02 | Income determination method: family size, current vs annual income, self-employment, in-kind | state_manual_or_regulation | 28 | 0 | 17 | 9 | 2 |
| wic_s05 | Nutritional risk criteria in use and who may determine risk (CPA) | state_manual_or_regulation | 28 | 0 | 17 | 9 | 2 |
| wic_s07 | Certification periods by category | state_manual_or_regulation | 28 | 0 | 17 | 9 | 2 |
| wic_s09 | Identity, residency and income documentation and verification | state_manual_or_regulation | 28 | 0 | 17 | 9 | 2 |
| wic_s11 | Priority system and waiting list management | state_manual_or_regulation | 28 | 0 | 17 | 9 | 2 |
