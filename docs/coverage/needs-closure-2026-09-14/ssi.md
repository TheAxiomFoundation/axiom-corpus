...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| cells | 6567 | 110 | 83 | 8 | 44 | 6812 |

Federal elements are checked once and inherited by the 51 states (`evidence_note` = `inherited from federal`); the federal row alone: PRESENT 123, EXTRACTABLE 2, ABSENT 6. State-level cells (51 x 6): PRESENT 171, EXTRACTABLE 6, ABSENT 77, OUTREACH 8, REVIEW 44.

## Federal roll-up by document family

| federal family | elements | PRESENT | EXTRACTABLE | ABSENT | OUTREACH | REVIEW |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| statute (US Code Title 42 ch. 7 subch. XVI) | 20 | 20 | 0 | 0 | 0 | 0 |
| regulation (eCFR) | 23 | 22 | 1 | 0 | 0 | 0 |
| agency manual (SSA POMS part SI) | 79 | 78 | 1 | 0 | 0 | 0 |
