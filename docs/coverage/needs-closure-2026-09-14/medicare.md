...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| cells | 3339 | 104 | 7 | 18 | 68 | 3536 |

Federal elements are checked once and inherited by the 51 states (`evidence_note` = `inherited from federal`); the federal row alone: PRESENT 59, EXTRACTABLE 2, ABSENT 7. State-level cells (51 x 7): PRESENT 271, OUTREACH 18, REVIEW 68.

## Federal roll-up by document family

| federal family | elements | PRESENT | EXTRACTABLE | ABSENT | OUTREACH | REVIEW |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| statute (US Code Title 42 ch. 7 subch. XVIII / XIX) | 24 | 24 | 0 | 0 | 0 | 0 |
| regulation (eCFR) | 7 | 7 | 0 | 0 | 0 | 0 |
| agency manual (CMS IOM) | 19 | 17 | 2 | 0 | 0 | 0 |
| agency manual (SSA POMS part HI) | 6 | 6 | 0 | 0 | 0 | 0 |
| annual notice (Federal Register / CMS) | 4 | 4 | 0 | 0 | 0 | 0 |
