...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| cells | 1752 | 228 | 44 | 1 | 107 | 2132 |

Federal elements are checked once and inherited by the 51 states (`evidence_note` = `inherited from federal`); the federal row alone: PRESENT 20, EXTRACTABLE 3, ABSENT 18. State-level cells (51 x 18): PRESENT 712, EXTRACTABLE 72, ABSENT 26, OUTREACH 1, REVIEW 107.

## Federal roll-up by document family

| federal family | elements | PRESENT | EXTRACTABLE | ABSENT | OUTREACH | REVIEW |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| statute (US Code Title 42 ch. 94 subch. II) | 10 | 10 | 0 | 0 | 0 | 0 |
| regulation (eCFR, 45 CFR 96 subpart H) | 10 | 8 | 2 | 0 | 0 | 0 |
| annual notice (Federal Register, HHS/ASPE) | 1 | 1 | 0 | 0 | 0 | 0 |
| annual guidance (ACF OCS LIHEAP Information Memorandum) | 1 | 1 | 0 | 0 | 0 | 0 |
